...
-- modified by marshall from filename.lua
...
function M.update_status()
  ...
  return modules.utils.stl_escape(dirname)
end
...
function M:apply_icon()
  ...
  if ok then
    local f_name, f_extension = '', ''
    f_extension = f_extension ~= '' and f_extension or vim.bo.filetype
    _, icon_highlight_group = devicons.get_icon(f_name, f_extension)
    icon = ''
